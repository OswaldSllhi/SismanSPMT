...
use App\Filament\Resources\Iso9001Resource\Pages;
use App\Filament\Resources\Iso9001Resource\RelationManagers;
...
class Iso9001Resource extends Resource
{
    protected static ?string $model = Iso9001::class;
    ...
    {
        return [
            'index' => Pages\ListIso9001s::route('/'),
            'create' => Pages\CreateIso9001::route('/create'),
            'edit' => Pages\EditIso9001::route('/{record}/edit'),
        ];
    }
}
