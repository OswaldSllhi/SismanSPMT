...
use App\Filament\Resources\Iso14001Resource\Pages;
use App\Filament\Resources\Iso14001Resource\RelationManagers;
...
class Iso14001Resource extends Resource
{
    protected static ?string $model = Iso14001::class;
    ...
    {
        return [
            'index' => Pages\ListIso14001s::route('/'),
            'create' => Pages\CreateIso14001::route('/create'),
            'edit' => Pages\EditIso14001::route('/{record}/edit'),
        ];
    }
}
